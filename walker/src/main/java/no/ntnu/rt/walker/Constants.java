...
public class Constants {
    ...
    public static Integer[] leftFootInit = new Integer[]{37, 30, 90, 80};
    public static Integer[] rightFootInit = new Integer[]{37, 30, 70, 80};
    public static Integer[] leftFootWalk0 = new Integer[]{37, 10, 130, 80};
    ...
    public static Integer[] currentFootState = new Integer[]{37, 10, 90, 80};
