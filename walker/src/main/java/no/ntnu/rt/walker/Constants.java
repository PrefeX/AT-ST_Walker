...
public class Constants {
    ...
    public static Integer[] leftFootInit = new Integer[]{37, 50, 130, 90};
    public static Integer[] rightFootInit = new Integer[]{37, 50, 130, 90};
    public static Integer[] leftFootWalk0 = new Integer[]{37, 40, 170, 70};
    public static Integer[] leftFootWalk1 = new Integer[]{37, 50, 130, 90};
